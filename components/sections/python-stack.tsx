...
function Glyph({ kind }: { kind: string }) {
  const c =
    "h-12 w-12 text-foreground/50 transition-colors duration-300 group-hover/card:text-foreground/80";
  const s = {
    stroke: "currentColor",
    strokeWidth: 1.6,
...
export default function PythonStack() {
  return (
    <Section id="python-stack">
      ...
      >
        <p>
          Each component is there because it closes a specific risk from the threat model. Mature,
          audited, and understood by the security team you already have.
        </p>
      </SectionHead>
